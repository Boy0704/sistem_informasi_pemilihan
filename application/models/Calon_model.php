...
class Calon_model extends CI_Model
{
	...
	$this->db->or_like('no_calon', $q);
	$this->db->or_like('nama_calon', $q);
	$this->db->or_like('visi', $q);
	$this->db->or_like('misi', $q);
	$this->db->or_like('foto', $q);
	$this->db->or_like('program_lain', $q);
	$this->db->or_like('id_pemilihan', $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-10-30 16:26:20 */
/* http://harviacode.com */